/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    /***/ 754: /***/ (
      ...
      module.exports = {
        parallel: __nccwpck_require__(932),
        serial: __nccwpck_require__(597),
        serialOrdered: __nccwpck_require__(297),
      };
    ...
    /***/ 296: /***/ (
      ...
      var defer = __nccwpck_require__(58);
    ...
    /***/ 585: /***/ (
      ...
      var async = __nccwpck_require__(296),
        abort = __nccwpck_require__(349);
      // API
    ...
    /***/ 544: /***/ (
      ...
      var abort = __nccwpck_require__(349),
        async = __nccwpck_require__(296);
      // API
    ...
    /***/ 932: /***/ (
      ...
      var iterate = __nccwpck_require__(585),
        initState = __nccwpck_require__(919),
        terminator = __nccwpck_require__(544);
      // Public API
    ...
    /***/ 597: /***/ (
      ...
      var serialOrdered = __nccwpck_require__(297);
    ...
    /***/ 809: /***/ (module, exports, __nccwpck_require__) => {
      /**
      ...
      exports = module.exports = __nccwpck_require__(918);
      exports.log = log;
    ...
    /***/ 918: /***/ (module, exports, __nccwpck_require__) => {
      /**
      ...
      exports.humanize = __nccwpck_require__(290);
    ...
    /***/ 361: /***/ (module, exports, __nccwpck_require__) => {
      /**
       * Module dependencies.
       */
      ...
      module.exports = function () {
        if (!debug) {
          try {
            ...
            debug = __nccwpck_require__(680)("follow-redirects");
          } catch (error) {
            /* */
          }
    ...
    /***/ 505: /***/ (
      ...
      var debug = __nccwpck_require__(230);
    ...
    /***/ 152: /***/ (
      ...
      var CombinedStream = __nccwpck_require__(108);
      var util = __nccwpck_require__(837);
      ...
      var fs = __nccwpck_require__(147);
      var Stream = __nccwpck_require__(781).Stream;
      var mime = __nccwpck_require__(654);
      var asynckit = __nccwpck_require__(754);
      var populate = __nccwpck_require__(719);
    ...
    /***/ 171: /***/ (
      ...
      module.exports = __nccwpck_require__(392);
    ...
    /***/ 654: /***/ (
      ...
      var db = __nccwpck_require__(171);
    ...
    /***/ 951: /***/ (
      ...
      const FormData$1 = __nccwpck_require__(152);
      ...
      const followRedirects = __nccwpck_require__(505);
      const zlib = __nccwpck_require__(796);
      const stream = __nccwpck_require__(781);
      const EventEmitter = __nccwpck_require__(820);
      ...
      const buildAddressEntry = (address, family) =>
        resolveFamily(
          utils$1.isObject(address) ? address : { address, family }
        );
  ...
  (() => {
    const fs = __nccwpck_require__(147);
    const fs2 = __nccwpck_require__(147).promises;
    __nccwpck_require__(541).config();
    const axios = __nccwpck_require__(951);

    const { createWriteStream } = __nccwpck_require__(147);
    ...
    async function createNotebook(fileName, fileContent, Path) {
      const filePath = join("./" + Path, fileName);
      ...
      try {
        ...
        console.error(`Error creating notebook '${fileName}':`, error);
      }
    }
